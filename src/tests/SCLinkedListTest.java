...
import ListaCircularSimplesmenteEncadeada.EmptySCLinkedList;
import ListaCircularSimplesmenteEncadeada.SCLinkedList;
import org.junit.jupiter.api.Test;

import static org.junit.jupiter.api.Assertions.assertEquals;
import static org.junit.jupiter.api.Assertions.assertThrows;

public class SCLinkedListTest {

    @Test
    void testAddHead() {
        SCLinkedList s = new SCLinkedList();
    ...
    void testRemoveFirst() {
        ...
        assertThrows(EmptySCLinkedList.class, () -> {
            s.removeFirst();
        });
    }
}
